...
import {
	SwitchContainer,
	SwitchItem,
} from "@/components/animations/animated-switch";
					...
					<div className="col-span-2 flex flex-col gap-4 p-8 md:p-14">
						<div className="space-y-4">
							...
							<p className="text-balance text-muted-foreground">
								Try free for 14 days with full access to all features. Upgrade
								only when your AI agent proves value.
							</p>
						</div>
						<div className="pt-4">
							<SwitchContainer
							...
							>
								...
								<SwitchItem value="annually" label="Annually" />
							</SwitchContainer>
						</div>
					</div>
					...
					<div className="col-span-4 flex flex-col">
						...
						<div className="grid grid-cols-1 items-stretch gap-6 border-b md:grid-cols-2">
							{paidPlans.map((plan) => {
								...
								const pricePeriod = isYearly ? "year" : plan.period;
								...
								<div className="grid grid-cols-1 border-t md:grid-cols-5">
									<div className="col-span-3 p-6 md:p-8">
										...
										<div className="mb-2 flex items-baseline gap-2">
											<span className="text-3xl font-medium md:text-4xl">
												{isYearly ? freePlan.yearlyPrice : freePlan.price}
											</span>
											<span className="text-muted-foreground">
