...
import { CodeReviewBlock } from "@/components/animations/sections/code-review-block";
import { TerminalBrowserPreviewBlock } from "@/components/animations/sections/terminal-browser-preview";
